...
for run_id in {0..9}; do
    ...
    srun --export=ALL,INFL_SEED=$run_id,INFL_CWD=$task_cwd python /home/dvitel.usf/nn-infl/src/exp.py finetune --task=$task --model=roberta-large --num-epochs=30 --unfreeze-regex=.\*\\.word_embeddings\\..\*
