...
for run_id in {0..10}; do
    ...
    srun --export=ALL,INFL_SEED=$run_id,INFL_CWD=$task_cwd python ~/infl/src/exp.py finetune2 --task=$task --filter-method=infl --infl-method=datainf --module-pattern=.\*\\.layer\\.\(1\[6-9\]\|2\[0-3\]\)\\..\*\\.lora_\(A\|B\)\\..\*
