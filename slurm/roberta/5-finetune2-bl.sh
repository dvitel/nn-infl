...
seeds=(117 191)
module_names=('WE' '' '00-05' '06-11' '12-17' '18-23' '00-05 A' '06-11 A' '12-17 A' '18-23 A' '00-05 B' '06-11 B' '12-17 B' '18-23 B' 'CL')
        ...
        for module_name in "${module_names[@]}"; do
            for run_id in {0..4}; do
                ...
                HF_TOKEN=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 INFL_SEED=$run_id INFL_CWD=$task_cwd python \
                    ...
                    --s-prefix=s_bl --unfreeze-regex=.\*\\.embed_tokens\\..\* --seed2=$seed2 \
                    --metrics-file=m-bl.jsonlist
