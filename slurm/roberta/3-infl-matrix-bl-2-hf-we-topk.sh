#!/bin/bash -l
#SBATCH --job-name=r-hf-we-t2
#SBATCH --time=72:00:00
#SBATCH --output i-hf-we-t2-%a.out
...
for run_id in {0..4}; do
    ...
    HF_TOKEN=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 INFL_SEED=$run_id INFL_CWD=$task_cwd python \
        /home/dvitel.usf/nn-infl/src/exp.py infl-matrix --task=$task --methods=$method_name --mem-koef=$mem_koef --m-prefix=m_bl --i-prefix=i_bl
